    ...
    process.nextTick(function(){
        User.findOne({
            ...
            if(err) return done(err);
                ...
                return done(null, false, req.flash('sifn-in-msg','Oops! Wronf pass'));
            }

            else if(!user.isEmailConfirmed()){
                return done(null, false, req.flash('sifn-in-msg','your email has not been confirmed'));
            }
                    ...
                    newUser.save(function(err){
                        ...
                        let mailOptions = {
                            ...
                            <p>
                                ...
                                <a href='http://${req.header.host}/email-confirmation/${emailHash}'>
